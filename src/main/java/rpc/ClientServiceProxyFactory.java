...
public class ClientServiceProxyFactory {
	public static Object getClientService(Class interfaceClazz) {
		...
		return Proxy.newProxyInstance(interfaceClazz.getClassLoader(), new Class[]{interfaceClazz}, (proxy, method, args) -> getRPCResulet(method,args));
	...
	private static String[] getPath(){
		try {
			Method method = Client.class.getDeclaredMethod("sendMsg", String.class);
